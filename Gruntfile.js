module.exports = function (grunt) {
  ...
  grunt.registerTask('start', ['run:server', 'open:localhost', 'wait:server']);
  grunt.registerTask('landing', ["watch:B"]);
  grunt.registerTask('app', ["watch:A"]);
  grunt.registerTask('run', ['express:server', 'express-keepalive']);
  grunt.registerTask('default', ['build']);
  grunt.registerTask('serve', ['build', 'run']);
